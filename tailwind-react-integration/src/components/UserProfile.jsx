    ...
    return (
        <div className="container">
            <div className="user-profile bg-gray-100 p-4 md:p-8 max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg text-center">
                ...
                <img className="rounded-full w-24 h-24 md:w-36 md:h-36 mx-auto mb-4" src="https://via.placeholder.com/150" alt="User" />
                <h1 className="sm:text-lg md:text-xl text-blue-800 my-4">Freaky Coding!</h1>
                <p className="text-sm md:text-base text-gray-600">Developer at Example Co.
